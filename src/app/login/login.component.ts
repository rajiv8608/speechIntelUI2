...
export class LoginComponent implements OnInit {
  ...
  constructor(private router: Router, private _fb: FormBuilder, private _dataSerice: DataService, private _authService: AuthService, private _loginService: LoginService) {
  ...
  loginUser() {
    ...
    this._loginService.logIn(environment.user_Api, credentials).subscribe(data => { // checking credentials to login, setting token and role for the user
